        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-stone-50: oklch(.985 0 0);
                    --color-stone-100: oklch(.97 0 0);
                    --color-stone-200: oklch(.922 0 0);
                    --color-stone-300: oklch(.87 0 0);
                    --color-stone-400: oklch(.708 0 0);
                    --color-stone-500: oklch(.556 0 0);
                    --color-stone-600: oklch(.439 0 0);
                    --color-stone-700: oklch(.371 0 0);
                    --color-stone-800: oklch(.269 0 0);
                    --color-stone-900: oklch(.205 0 0);
                    --color-stone-950: oklch(.145 0 0);
